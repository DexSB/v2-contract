...
import { MapXMoneylineHandler } from "../../src/handler/MapXMoneylineHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract MapXMoneylineHandlerTest is Test {
    MapXMoneylineHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new MapXMoneylineHandler();
    }
