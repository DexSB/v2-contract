...
import { MatchHandicapHandler } from "../../src/handler/MatchHandicapHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract MatchHandicapHandlerTest is Test {
    MatchHandicapHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new MatchHandicapHandler();
    }
