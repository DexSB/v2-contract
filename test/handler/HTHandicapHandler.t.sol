...
import { HTHandicapHandler } from "../../src/handler/HTHandicapHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract HTHandicapHandlerTest is Test {
    HTHandicapHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new HTHandicapHandler();
    }
