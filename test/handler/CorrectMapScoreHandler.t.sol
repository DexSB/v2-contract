...
import { CorrectMapScoreHandler } from "../../src/handler/CorrectMapScoreHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract CorrectMapScoreHandlerTest is Test {
    CorrectMapScoreHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new CorrectMapScoreHandler();
    }
