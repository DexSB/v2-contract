...
import { HTMoneylineHandler } from "../../src/handler/HTMoneylineHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract HTMoneylineHandlerTest is Test {
    HTMoneylineHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new HTMoneylineHandler();
    }
