...
import { QuarterMoneylineHandler } from "../../src/handler/QuarterMoneylineHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract QuarterMoneylineHandlerTest is Test {
    QuarterMoneylineHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new QuarterMoneylineHandler();
    }
