...
import { QuarterHandicapHandler } from "../../src/handler/QuarterHandicapHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract QuarterHandicapHandlerTest is Test {
    QuarterHandicapHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new QuarterHandicapHandler();
    }
