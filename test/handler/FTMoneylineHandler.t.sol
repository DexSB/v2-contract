...
import { FTMoneylineHandler } from "../../src/handler/FTMoneylineHandler.sol";
import { TicketStatus, ResultStatus } from "../../src/constant/Status.sol";

contract FTMoneylineHandlerTest is Test {
    FTMoneylineHandler private handler;

    address private oracle = makeAddr("oracle");

    function setUp() public {
        handler = new FTMoneylineHandler();
    }
